...
MAX_POSSIBLE_HISTORY_SLOTS = 24  # Matches HISTORY_SLOT_OPTIONS max value
HISTORY_SLOT_OPTIONS = [10, 13, 15, 17, 20, 24] # New options for Max History Slots
MAX_POSSIBLE_ATTACH_SLOTS = 12  # Matches ATTACH_SLOT_OPTIONS max value
ATTACH_SLOT_OPTIONS = [2, 4, 6, 8, 10, 12] # New options for Max Attach Slots
SESSION_LOG_HEIGHT_OPTIONS = [400, 450, 475, 500, 550, 600]
INPUT_LINES_OPTIONS = [2, 4, 5, 6, 8, 11, 15]
