...
QT_VERSION = 5              # Always Qt5 (PyQt5); written by installer
DX_FEATURE_LEVEL = 0        # DirectX feature level (0xa000 = 10.0, 0xb000 = 11.0)
GRAPHICS_ACCELERATION = True  # Set by installer; False = software rendering for Qt WebEngine
GRADIO_VERSION = "3.50.2"   # Always Gradio 3.50.2; written by installer
...
def load_system_ini():
    ...
    try:
        ...
        # NEW: Load Qt version from INI (installer determines this based on GPU)
        QT_VERSION = system.getint('qt_version', 5)  # Default to 5 if missing
        DX_FEATURE_LEVEL = system.getint('dx_feature_level', 0xb000)  # Default to 11.0
