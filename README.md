...
- **Comprihensive CPU/GPU Support**: Compatible with, CPUs x64-CPU/Multi-CPU/AVX2/AVX512 and GPUs AMD/nVIDIA via Vulkan/Kompute/Cuda, with dynamic selection dropdown.
