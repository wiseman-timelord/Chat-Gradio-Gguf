...
- Full testing on windows 8.1 (so likely 100% working for windows 7-8.1 userx).
- 2 scripts merged, `models+prompts=inference.py` and `settings+temporary=configuration.py`. For better editing when AI limits scripts, ie `Qwen.ai`.
