...
### Status
Beta - Working fine during tests on v0.99.x on my, Ubuntu 25 and Windows 8.1, systems, try latest release. Recently upgraded search for more intelligent DDG Searches. Next we will have full bugfix on Ubuntu, and then v1.00.0!!!
