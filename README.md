...
<br>2. Full logic and sanity check, as well as check for redundant unused code, then afterwards some optimization to reduce overall characters in inefficient function(s), more optimal ways of doing things, as well as possibly some refractoring.
<br>3. New Operation/Panel Modes have a delay, look at code and make more efficient and optimal, instead of delay. it takes 2 seconds, so I am assuming its not loading the model, but possibly checking something, or saving/loading the json?
