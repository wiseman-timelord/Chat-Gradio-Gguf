...
### Status
Beta - Unfortunately TTS had to be removed; there is no way to have consistent libraries over the range of OS intended to be covered, resulting in highly complicated tool install/configuration. The TTS and/or more tools, will not be attempted again until claude is v5, or at least I can do optimization + fixes. After v1.00.0, I will have a break from C-G-G project and, Instead there will be Chat-Lightwave-Gguf with edge viewer, specifically for windows 8.1-11.
