...
### Status
Beta - Latest release v1.03.x now includes Corqui TTS with its own installer pages. This version has been tested so far on Windows 8.1, however if it does not work on Ubuntu, then try previous release v1.02.x.
