...
- The Session Log on Window, showing, both sidepanels collapsed and the Web Search tool test. (Qwen 3.6 model on v2.00.10)...
![image_missing](media/v2_00_10_Qwen36.jpg)
...
- The dynamic progress indication replaces the user input box upon submission (Windows v2.00.10)...
