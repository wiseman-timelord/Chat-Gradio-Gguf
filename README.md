...
```
- All above was delayed, and so found solution is xllamacpp. This will remove need for wheel compatibility AND speed up responses due to pre-built vulkan wheels option. Working on this now.
