...
### Status
Beta - Working fine on v0.99.x on my, Ubuntu 25 and Windows 8.1, systems, however, there are some issues with Web Search actually searching correctly, so this part is having a little inspection, while also upgrading with intelligent usage cases for, no websearch / ddg only / web only / ddg + web, operation.
