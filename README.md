...
### Status
Beta - Working fine on v0.98.x on my Windows 8.1 system, however upcoming v0.99.0 will have improved TTS for windows 8.1-11 and ubuntu 24-25. Currently enhancing operation, in preperation/buildup to v1.00.0 and the ending of v1 of the project, leading to, v1.01.0-v2.00.0 phase and/or other projects, and most important ME HAVING THIS GREAT CHATBOT SOFTWARE TO USE. There will be a full demonstration video upcoming, of course!
