...
### Status
Beta - Release version works (last tested on Ubuntu 25).
...
- The Interaction page on Ubuntu, here showing the DDG Search function, with Ubuntu Terminal in the background (v1.02.1)...
