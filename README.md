...
- [Gradio](https://gradio.app/), [PyTorch](https://pytorch.org/), [llama-cpp-python](https://llama-cpp-python.readthedocs.io/), [sentence-transformers](https://sbert.net/), [LangChain](https://www.langchain.com/), [spaCy](https://spacy.io/), [PyQt6](https://www.riverbankcomputing.com/software/pyqt/), [Coqui TTS](https://github.com/coqui-ai/tts), [Beautiful Soup](https://www.crummy.com/software/BeautifulSoup/), [Numpy](https://numpy.org/), [Transformers](https://huggingface.co/docs/transformers/), [faiss-cpu](https://github.com/facebookresearch/faiss), [Aiohttp](https://aiohttp.readthedocs.io/), [Newspaper4k](https://github.com/codelucas/newspaper) - Python Libraries.
