...
|--------------------|------------------------------------|------------------------------------|-------------------------------|----------------------------------|-----------------|------------------|
| **Average**        | 37.30%                            | 47.09%                            | 47.37%                       | 52.08%                          | ~75%*           | ~80%*            |
...
4. testing these models...
- `https://huggingface.co/mradermacher/Qwen2.5-Dyanka-7B-Preview-GGUF` - 7th best ~8b model, 455 overall.
