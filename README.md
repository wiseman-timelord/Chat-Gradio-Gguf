...
- The Preferences page, the settings for, GUI, Operation, Filters (Windows v2.04)...
![image_missing](media/preferences_page.jpg)
...
- More work on output formatting, using larger outputs, such as example in "2026-08-19 10:10" slot. When producing larger outputs it uses more conventions for formatting ie bold subtitles with short paragraph underneath, these need a little formatting edit also.
