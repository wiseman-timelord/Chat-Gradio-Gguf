...
1. The given complete prompt/response in the session log, should have little buttons on the edges.. 
...
2. the program needs to be compatible with the qwen 3.5/3.6 with/without huihui/abliterated/ClaudeOpus/Heretic enhancment handling.
